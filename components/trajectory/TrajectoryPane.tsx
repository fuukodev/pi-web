        ...
        {searchOpen ? (
          ...
          <>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6, flexShrink: 0 }}>
              ...
              <button type="button" onClick={() => setSearchOpen(true)} title={t("trajectory.search")} aria-label={t("trajectory.search")} style={{ flexShrink: 0, display: "grid", placeItems: "center", width: 30, height: 30, padding: 0, border: "1px solid var(--border)", borderRadius: 4, background: "transparent", color: "var(--text-muted)", cursor: "pointer", lineHeight: 1 }}>
