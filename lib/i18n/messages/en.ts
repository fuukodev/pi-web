...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.consultationContext": "Reference context",
    "chat.consultationSelectionOnly": "Selected output only",
    "chat.consultationCurrentTurn": "Include current turn",
    "chat.consultationFailed": "Unable to start the consultation.",
      "consultation.title": "Consultations",
    "consultation.count": "{count} saved consultation(s)",
    "consultation.parent": "Parent conversation",
    "consultation.currentTurn": "Selected output + current turn",
    "consultation.selectionOnly": "Selected output only",
