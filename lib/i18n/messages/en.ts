...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "trajectory.unsaved": "Trajectory is available after the session is saved",
    "trajectory.title": "Execution trajectory",
    "trajectory.overview": "Overview",
    "trajectory.ledger": "Ledger",
    "trajectory.inspector": "Event details",
    "trajectory.loadEarlier": "Load earlier turns",
    "trajectory.loading": "Loading trajectory…",
    "trajectory.loadingDetails": "Loading event details…",
    "trajectory.error": "Unable to load trajectory",
    "trajectory.retry": "Retry",
    "trajectory.empty": "No trajectory records yet",
    "trajectory.selectRecord": "Select a record to inspect its details",
    "trajectory.closeInspector": "Close event details",
    "trajectory.copyRecord": "Copy record",
    "trajectory.copySuccess": "Copied",
    "trajectory.copyFailed": "Could not copy record",
    "trajectory.live": "Live",
    "trajectory.collapseRun": "Collapse agent run",
    "trajectory.expandRun": "Expand agent run",
    "trajectory.stopReason": "stop: {reason}",
    "trajectory.toolsCount": "{count} tools",
    "trajectory.tokensCount": "{count} tokens",
    "trajectory.liveLoading": "Loading…",
    "trajectory.running": "Running",
    "trajectory.complete": "Complete",
    "trajectory.errorStatus": "Error",
    ...
    "trajectory.modelChange": "Model change",
    "trajectory.thinkingChange": "Thinking level",
    "trajectory.branchSummary": "Branch summary",
    "trajectory.custom": "Custom",
    "trajectory.summary": "Summary",
    "trajectory.message": "Message",
    "trajectory.command": "Command",
    "trajectory.payload": "Payload",
    "trajectory.result": "Result",
    "trajectory.schema": "Schema",
    "trajectory.timing": "Timing",
    "trajectory.source": "Source",
    "trajectory.duration": "Duration",
    "trajectory.estimated": "estimated",
    "trajectory.liveDuration": "live",
    "trajectory.notAvailable": "Not available",
    "trajectory.turnCount": "{count} turns",
    "trajectory.recordCount": "{count} records",
    "trajectory.moreRecords": "{count} more",
    "trajectory.search": "Search trajectory",
    "trajectory.searchPlaceholder": "Search messages and tool calls",
    "trajectory.searchAllTypes": "All",
    "trajectory.searchTypeLabel": "Filter by record type",
    "trajectory.searchResults": "{count} matches",
    "trajectory.searching": "Searching…",
    "trajectory.searchNoResults": "No matches",
    "trajectory.searchTruncated": "Showing the newest {count} matches",
    "trajectory.searchHint": "Filter with a prefix: user:, assistant:, thinking:, tool:",
    "trajectory.searchClose": "Close search",
    "trajectory.searchFieldThinking": "thinking",
    ...
    "chat.locatingMessage": "Locating message…",
    ...
    "models.defaultsThinking": "Default thinking level",
    "models.defaultsThinkingPinned": "Used unless the model or a per-model override says otherwise.",
    "models.defaultsThinkingBuiltin": "Not pinned — pi's built-in default is {level}.",
    "models.defaultsThinkingUnsupported": "{model} does not support this level, so pi clamps it per session (supported: {levels}).",
    "models.defaultsEffective": "After the enabledModels scope is applied, new sessions currently start with {model}.",
    ...
    "models.warning.unsupported_thinking_level": "This model supports: {detail}",
    ...
    "palette.placeholder": "Search files, or type a prefix: > commands, @ sessions, # workspaces",
    "palette.filesPlaceholder": "Search files in this workspace...",
    "palette.commandsPlaceholder": "Type > then a command name...",
    "palette.sessionsPlaceholder": "Type @ then a session name...",
    "palette.workspacesPlaceholder": "Type # then a workspace name...",
    "palette.mode.files": "Files",
    "palette.mode.commands": "Commands",
    "palette.mode.sessions": "Sessions",
    "palette.mode.workspaces": "Workspaces",
    "palette.hintEmpty": "Type to search files in this workspace",
    "palette.searching": "Searching...",
    "palette.searchFailed": "File search failed",
    "palette.noMatches": "No matches",
    "palette.untitledSession": "Untitled session",
    "palette.sessionCount": "{count} sessions",
    "palette.footer": "↑↓ select · ↵ open · esc close · > commands · @ sessions · # workspaces",
    "shortcuts.action.paletteFiles": "Search files",
    "shortcuts.action.paletteCommands": "Command palette",
    "shortcuts.action.paletteSessions": "Search sessions",
    "shortcuts.action.paletteWorkspaces": "Switch workspace",
    "shortcuts.action.sessionNew": "New session",
    "shortcuts.action.sidebarToggle": "Toggle sidebar",
    "shortcuts.action.panelToggle": "Toggle file panel",
    "shortcuts.action.tabNext": "Next tab",
    "shortcuts.action.tabPrev": "Previous tab",
    "shortcuts.action.tabClose": "Close current tab",
    "shortcuts.action.settingsOpen": "Open settings",
    "shortcuts.action.themeToggle": "Toggle theme",
    "shortcuts.title": "Keyboard shortcuts",
    "shortcuts.description": "Click a binding to record a new key. Plain-key sequences (like g f) only fire outside text inputs; modified chords (ctrl/alt) work everywhere. Escape is reserved by the app. Changes apply after you click Save.",
    "shortcuts.group.palette": "Command palette",
    "shortcuts.group.sessions": "Sessions",
    "shortcuts.group.layout": "Layout and tabs",
    ...
    "shortcuts.unsavedChanges": "{count} unsaved change(s)",
    "shortcuts.recording": "Press keys... (up to 2 chords; Esc cancels)",
    "shortcuts.recordingWaiting": "Recording {binding} — press another chord to make a sequence, wait to finish",
    "shortcuts.invalidBinding": "Invalid binding: {reason}",
    "shortcuts.conflictWith": "Conflicts with {action}",
    "shortcuts.reason.empty": "empty binding",
    "shortcuts.reason.syntax": "use modifier+key, e.g. ctrl+shift+p, or a sequence like g w",
    "shortcuts.reason.unknown-key": "unknown key name",
    "shortcuts.reason.reserved-key": "this key is reserved by the app",
    "shortcuts.shortcuts": "Keys",
    "commands.newSession": "New session",
    "commands.toggleSidebar": "Toggle sidebar",
    "commands.togglePanel": "Toggle file panel",
    "commands.closeTab": "Close current tab",
    "commands.nextTab": "Next tab",
    "commands.prevTab": "Previous tab",
    "commands.openSettings": "Open settings",
    "commands.toggleTheme": "Toggle theme",
    "commands.searchFiles": "Search files",
    "commands.searchSessions": "Search sessions",
    "commands.switchWorkspace": "Switch workspace",
},
};
