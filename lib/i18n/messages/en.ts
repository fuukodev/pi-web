...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "shortcuts.description": "Click a binding to record a new key. Plain-key sequences (like g f) only fire outside text inputs; modified chords (ctrl/alt) work everywhere. Escape is reserved by the app.",
