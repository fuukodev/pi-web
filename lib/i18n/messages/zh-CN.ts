...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.consultationContext": "参考上下文",
    "chat.consultationSelectionOnly": "仅选中内容",
    "chat.consultationCurrentTurn": "包含本轮上下文",
    "chat.consultationFailed": "无法启动临时咨询。",
      "consultation.title": "临时咨询",
    "consultation.count": "已保存 {count} 条咨询",
    "consultation.parent": "主对话",
    "consultation.currentTurn": "选中内容 + 本轮上下文",
    "consultation.selectionOnly": "仅选中内容",
