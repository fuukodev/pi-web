...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "trajectory.unsaved": "保存会话后才能查看执行轨迹",
    "trajectory.title": "执行轨迹",
    "trajectory.overview": "概览",
    "trajectory.ledger": "记录",
    "trajectory.inspector": "事件详情",
    "trajectory.loadEarlier": "加载更早的回合",
    "trajectory.loading": "正在加载执行轨迹…",
    "trajectory.loadingDetails": "正在加载事件详情…",
    "trajectory.error": "无法加载执行轨迹",
    "trajectory.retry": "重试",
    "trajectory.empty": "暂时没有轨迹记录",
    "trajectory.selectRecord": "选择一条记录查看详情",
    "trajectory.closeInspector": "关闭事件详情",
    "trajectory.copyRecord": "复制记录",
    "trajectory.copySuccess": "已复制",
    "trajectory.copyFailed": "无法复制记录",
    "trajectory.live": "实时",
    "trajectory.collapseRun": "折叠 Agent 运行",
    "trajectory.expandRun": "展开 Agent 运行",
    "trajectory.stopReason": "结束原因：{reason}",
    "trajectory.toolsCount": "{count} 个工具调用",
    "trajectory.tokensCount": "{count} 个 token",
    "trajectory.liveLoading": "加载中…",
    "trajectory.running": "运行中",
    "trajectory.complete": "已完成",
    "trajectory.errorStatus": "错误",
    ...
    "trajectory.tool": "工具",
    "trajectory.bash": "命令",
    "trajectory.compaction": "压缩",
    "trajectory.modelChange": "模型变更",
    "trajectory.thinkingChange": "思考等级",
    "trajectory.branchSummary": "分支摘要",
    "trajectory.custom": "自定义",
    "trajectory.summary": "摘要",
    "trajectory.message": "消息",
    "trajectory.command": "命令",
    "trajectory.payload": "载荷",
    "trajectory.result": "结果",
    "trajectory.schema": "Schema",
    "trajectory.timing": "计时",
    "trajectory.source": "来源",
    "trajectory.duration": "耗时",
    "trajectory.estimated": "估算",
    "trajectory.liveDuration": "实时",
    "trajectory.notAvailable": "不可用",
    "trajectory.turnCount": "{count} 个回合",
    "trajectory.recordCount": "{count} 条记录",
    "trajectory.moreRecords": "另有 {count} 条",
    "trajectory.search": "搜索轨迹",
    "trajectory.searchPlaceholder": "搜索消息与工具调用",
    "trajectory.searchAllTypes": "全部",
    "trajectory.searchTypeLabel": "按记录类型筛选",
    "trajectory.searchResults": "{count} 个匹配",
    "trajectory.searching": "搜索中…",
    "trajectory.searchNoResults": "无匹配结果",
    "trajectory.searchTruncated": "仅显示最新 {count} 个匹配",
    "trajectory.searchHint": "可用 user:、assistant:、thinking:、tool: 前缀筛选",
    "trajectory.searchClose": "关闭搜索",
    ...
    "models.defaultsTitle": "启动默认值",
    "models.defaultsScope": "这些值保存在 pi 的全局设置中，作用于每个新的 pi 会话（包括 pi CLI/TUI）。在聊天中切换模型只影响当前会话。",
    "models.defaultsModel": "默认模型",
    "models.defaultsModelUnset": "尚未设置默认模型，pi 会从 enabledModels 范围中选择。",
    "models.defaultsThinking": "默认思考等级",
    "models.defaultsThinkingPinned": "除非模型自身或按模型的覆盖另有设置，否则使用该等级。",
    "models.defaultsThinkingBuiltin": "未固定 —— pi 内置默认为 {level}。",
    "models.defaultsThinkingUnsupported": "{model} 不支持该等级，pi 会在会话中自行降级（支持：{levels}）。",
    "models.defaultsEffective": "按 enabledModels 范围解析后，新会话目前使用 {model} 启动。",
    ...
    "models.warning.unsupported_thinking_level": "该模型支持：{detail}",
    ...
    "palette.title": "命令面板",
    "palette.placeholder": "搜索文件，或输入前缀：> 命令、@ 会话、# 工作区",
    "palette.filesPlaceholder": "搜索当前工作区文件…",
    "palette.commandsPlaceholder": "输入 > 加命令名…",
    "palette.sessionsPlaceholder": "输入 @ 加会话名…",
    "palette.workspacesPlaceholder": "输入 # 加工作区名…",
    "palette.mode.files": "文件",
    "palette.mode.commands": "命令",
    "palette.mode.sessions": "会话",
    "palette.mode.workspaces": "工作区",
    "palette.hintEmpty": "输入以搜索当前工作区文件",
    "palette.searching": "搜索中…",
    "palette.searchFailed": "文件搜索失败",
    "palette.noMatches": "无匹配结果",
    "palette.untitledSession": "未命名会话",
    "palette.sessionCount": "{count} 个会话",
    "palette.footer": "↑↓ 选择 · ↵ 打开 · esc 关闭 · > 命令 · @ 会话 · # 工作区",
    "shortcuts.action.paletteFiles": "搜索文件",
    "shortcuts.action.paletteCommands": "命令面板",
    "shortcuts.action.paletteSessions": "搜索会话",
    "shortcuts.action.paletteWorkspaces": "切换工作区",
    "shortcuts.action.sessionNew": "新建会话",
    "shortcuts.action.sidebarToggle": "切换侧栏",
    "shortcuts.action.panelToggle": "切换文件面板",
    "shortcuts.action.tabNext": "下一个标签页",
    "shortcuts.action.tabPrev": "上一个标签页",
    "shortcuts.action.tabClose": "关闭当前标签页",
    "shortcuts.action.settingsOpen": "打开设置",
    "shortcuts.action.themeToggle": "切换主题",
    "shortcuts.title": "键盘快捷键",
    "shortcuts.description": "点击键位进行录制。普通按键序列（如 g f）仅在输入框外生效；带 ctrl/alt 修饰键的组合全局生效。Esc 由应用保留。更改在点击保存后生效。",
    "shortcuts.group.palette": "命令面板",
    "shortcuts.group.sessions": "会话",
    "shortcuts.group.layout": "布局与标签页",
    "shortcuts.group.general": "通用",
    "shortcuts.unassigned": "未设置",
    "shortcuts.change": "修改",
    "shortcuts.reset": "重置",
    "shortcuts.resetAll": "全部重置",
    "shortcuts.discard": "放弃更改",
    "shortcuts.unsavedChanges": "{count} 项未保存的更改",
    "shortcuts.recording": "请按键…（最多 2 步序列；Esc 取消）",
    "shortcuts.recordingWaiting": "已录制 {binding} — 再按一键组成序列，或稍候完成",
    "shortcuts.invalidBinding": "无效键位：{reason}",
    "shortcuts.conflictWith": "与 {action} 冲突",
    "shortcuts.reason.empty": "键位为空",
    "shortcuts.reason.syntax": "请使用修饰键+按键（如 ctrl+shift+p），或序列（如 g w）",
    "shortcuts.reason.unknown-key": "未知按键名",
    "shortcuts.reason.reserved-key": "该按键由应用保留",
    "shortcuts.shortcuts": "快捷键",
    "commands.newSession": "新建会话",
    "commands.toggleSidebar": "切换侧栏",
    "commands.togglePanel": "切换文件面板",
    "commands.closeTab": "关闭当前标签页",
    "commands.nextTab": "下一个标签页",
    "commands.prevTab": "上一个标签页",
    "commands.openSettings": "打开设置",
    "commands.toggleTheme": "切换主题",
    "commands.searchFiles": "搜索文件",
    "commands.searchSessions": "搜索会话",
    "commands.switchWorkspace": "切换工作区",
},
};
