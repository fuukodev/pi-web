...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.consultationContext": "參考上下文",
    "chat.consultationSelectionOnly": "僅選取內容",
    "chat.consultationCurrentTurn": "包含本輪上下文",
    "chat.consultationFailed": "無法啟動臨時諮詢。",
      "consultation.title": "臨時諮詢",
    "consultation.count": "已儲存 {count} 則諮詢",
    "consultation.parent": "主對話",
    "consultation.currentTurn": "選取內容 + 本輪上下文",
    "consultation.selectionOnly": "僅選取內容",
