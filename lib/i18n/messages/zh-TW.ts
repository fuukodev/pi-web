...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "history.label": "完整紀錄",
    "trajectory.label": "執行軌跡",
    "trajectory.unsaved": "儲存工作階段後才能查看執行軌跡",
    "trajectory.title": "執行軌跡",
    "trajectory.overview": "概覽",
    "trajectory.ledger": "記錄",
    "trajectory.inspector": "事件詳細資料",
    "trajectory.loadEarlier": "載入更早的回合",
    "trajectory.loading": "正在載入執行軌跡…",
    "trajectory.loadingDetails": "正在載入事件詳細資料…",
    "trajectory.error": "無法載入執行軌跡",
    "trajectory.retry": "重試",
    "trajectory.empty": "目前沒有軌跡記錄",
    "trajectory.selectRecord": "選取記錄以查看詳細資料",
    "trajectory.closeInspector": "關閉事件詳細資料",
    "trajectory.copyRecord": "複製記錄",
    "trajectory.copySuccess": "已複製",
    "trajectory.copyFailed": "無法複製記錄",
    "trajectory.live": "即時",
    "trajectory.collapseRun": "摺疊 Agent 執行",
    "trajectory.expandRun": "展開 Agent 執行",
    "trajectory.stopReason": "結束原因：{reason}",
    "trajectory.toolsCount": "{count} 個工具呼叫",
    "trajectory.tokensCount": "{count} 個 token",
    "trajectory.liveLoading": "載入中…",
    "trajectory.running": "執行中",
    "trajectory.complete": "已完成",
    "trajectory.errorStatus": "錯誤",
    ...
    "trajectory.modelChange": "模型變更",
    "trajectory.thinkingChange": "思考層級",
    "trajectory.branchSummary": "分支摘要",
    "trajectory.custom": "自訂",
    "trajectory.summary": "摘要",
    "trajectory.message": "訊息",
    "trajectory.command": "指令",
    "trajectory.payload": "載荷",
    "trajectory.result": "結果",
    "trajectory.schema": "Schema",
    "trajectory.timing": "計時",
    "trajectory.source": "來源",
    "trajectory.duration": "耗時",
    "trajectory.estimated": "估算",
    "trajectory.liveDuration": "即時",
    "trajectory.notAvailable": "無法提供",
    "trajectory.turnCount": "{count} 個回合",
    "trajectory.recordCount": "{count} 筆記錄",
    "trajectory.moreRecords": "另有 {count} 筆",
    "trajectory.search": "搜尋執行軌跡",
    "trajectory.searchPlaceholder": "搜尋訊息與工具呼叫",
    "trajectory.searchAllTypes": "全部",
    "trajectory.searchTypeLabel": "依記錄類型篩選",
    "trajectory.searchResults": "{count} 個相符",
    "trajectory.searching": "搜尋中…",
    "trajectory.searchNoResults": "沒有相符結果",
    "trajectory.searchTruncated": "僅顯示最新 {count} 個相符",
    "trajectory.searchHint": "可用 user:、assistant:、thinking:、tool: 前綴篩選",
    "trajectory.searchClose": "關閉搜尋",
    "trajectory.searchFieldThinking": "思考",
    ...
    "models.defaultsThinking": "預設思考層級",
    "models.defaultsThinkingPinned": "除非模型本身或個別模型的覆寫另有設定，否則使用此層級。",
    "models.defaultsThinkingBuiltin": "未固定 —— pi 內建預設為 {level}。",
    "models.defaultsThinkingUnsupported": "{model} 不支援此層級，pi 會在工作階段中自行降級（支援：{levels}）。",
    "models.defaultsEffective": "套用 enabledModels 範圍後，新工作階段目前以 {model} 啟動。",
    "models.defaultsNoModels": "沒有可用模型",
    "models.defaultsModelsUnavailable": "模型清單無法使用",
    "models.defaultsUnavailable": "無法讀取 ~/.pi/agent/settings.json。",
    "models.defaultsAutoSave": "變更會立即儲存",
    "models.warning.unsupported_thinking_level": "此模型支援：{detail}",
    ...
    "palette.title": "命令面板",
    "palette.placeholder": "搜尋檔案，或輸入前綴：> 命令、@ 會話、# 工作區",
    "palette.filesPlaceholder": "搜尋目前工作區檔案…",
    "palette.commandsPlaceholder": "輸入 > 加命令名…",
    "palette.sessionsPlaceholder": "輸入 @ 加會話名…",
    "palette.workspacesPlaceholder": "輸入 # 加工作區名…",
    "palette.mode.files": "檔案",
    "palette.mode.commands": "命令",
    "palette.mode.sessions": "會話",
    "palette.mode.workspaces": "工作區",
    "palette.hintEmpty": "輸入以搜尋目前工作區檔案",
    "palette.searching": "搜尋中…",
    "palette.searchFailed": "檔案搜尋失敗",
    "palette.noMatches": "無匹配結果",
    "palette.untitledSession": "未命名會話",
    "palette.sessionCount": "{count} 個會話",
    "palette.footer": "↑↓ 選擇 · ↵ 開啟 · esc 關閉 · > 命令 · @ 會話 · # 工作區",
    "shortcuts.action.paletteFiles": "搜尋檔案",
    "shortcuts.action.paletteCommands": "命令面板",
    "shortcuts.action.paletteSessions": "搜尋會話",
    "shortcuts.action.paletteWorkspaces": "切換工作區",
    "shortcuts.action.sessionNew": "新增會話",
    "shortcuts.action.sidebarToggle": "切換側欄",
    "shortcuts.action.panelToggle": "切換檔案面板",
    "shortcuts.action.tabNext": "下一個分頁",
    "shortcuts.action.tabPrev": "上一個分頁",
    "shortcuts.action.tabClose": "關閉目前分頁",
    "shortcuts.action.settingsOpen": "開啟設定",
    "shortcuts.action.themeToggle": "切換主題",
    "shortcuts.title": "鍵盤快速鍵",
    "shortcuts.description": "點擊鍵位進行錄製。普通按鍵序列（如 g f）僅在輸入框外生效；帶 ctrl/alt 修飾鍵的組合全域生效。Esc 由應用保留。變更在點擊儲存後生效。",
    "shortcuts.group.palette": "命令面板",
    "shortcuts.group.sessions": "會話",
    "shortcuts.group.layout": "版面配置與分頁",
    "shortcuts.group.general": "一般",
    "shortcuts.unassigned": "未設定",
    "shortcuts.change": "修改",
    "shortcuts.reset": "重設",
    "shortcuts.resetAll": "全部重設",
    "shortcuts.discard": "放棄變更",
    "shortcuts.unsavedChanges": "{count} 項未儲存的變更",
    "shortcuts.recording": "請按鍵…（最多 2 步序列；Esc 取消）",
    "shortcuts.recordingWaiting": "已錄製 {binding} — 再按一鍵組成序列，或稍候完成",
    "shortcuts.invalidBinding": "無效鍵位：{reason}",
    "shortcuts.conflictWith": "與 {action} 衝突",
    "shortcuts.reason.empty": "鍵位為空",
    "shortcuts.reason.syntax": "請使用修飾鍵+按鍵（如 ctrl+shift+p），或序列（如 g w）",
    "shortcuts.reason.unknown-key": "未知按鍵名",
    "shortcuts.reason.reserved-key": "該按鍵由應用保留",
    "shortcuts.shortcuts": "快速鍵",
    "commands.newSession": "新增會話",
    "commands.toggleSidebar": "切換側欄",
    "commands.togglePanel": "切換檔案面板",
    "commands.closeTab": "關閉目前分頁",
    "commands.nextTab": "下一個分頁",
    "commands.prevTab": "上一個分頁",
    "commands.openSettings": "開啟設定",
    "commands.toggleTheme": "切換主題",
    "commands.searchFiles": "搜尋檔案",
    "commands.searchSessions": "搜尋會話",
    "commands.switchWorkspace": "切換工作區",
},
};
