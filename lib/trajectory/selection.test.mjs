...
test("only persisted user, assistant, thinking, text, and tool records are inspectable", () => {
  ...
  assert.equal(isInspectableTrajectoryRecord(record("thinking")), true);
  assert.equal(isInspectableTrajectoryRecord(record("text")), true);
